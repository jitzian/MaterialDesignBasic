 ...
 * {@link FingerPrintFragment.OnFragmentInteractionListener} interface
...
public class FingerPrintFragment extends Fragment {
    ...
    FingerprintAuthDialogFragment fragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_finger_print, container, false);

        fragment = new FingerprintAuthDialogFragment();

        purchase_button = (Button) rootView.findViewById(R.id.purchase_button);

        purchase_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                fragment.show(getActivity().getFragmentManager(), "Authorization");
            }
        });
